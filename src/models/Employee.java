...
@NamedQueries({
        ...
        @NamedQuery(name = "getActiveEmployees" , query="SELECT e FROM Employee AS e WHERE e.delete_flag = 0"),
        @NamedQuery(name = "getActiveEmployeesCount",query="SELECT COUNT(e) FROM Employee AS e WHERE e.delete_flag = 0"),
})
@Entity
