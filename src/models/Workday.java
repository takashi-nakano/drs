...
@NamedQueries({
    ...
    @NamedQuery(name="getMonthList",query="SELECT new models.dto.MonthList(w.month_group) FROM Workday AS w WHERE w.month_group <=:month_group GROUP BY w.month_group ORDER BY w.month_group DESC"),
